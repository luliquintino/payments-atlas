...
const categories: Category[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { name: "API Design", href: "/knowledge/api-design", description: "REST, idempot\u00eancia, webhooks, error handling" },
      { name: "Adyen Deep Dive", href: "/knowledge/psp/adyen", description: "Arquitetura, APIs e integracao Adyen" },
      { name: "Stripe Deep Dive", href: "/knowledge/psp/stripe", description: "Arquitetura, APIs e integracao Stripe" },
      { name: "dLocal Deep Dive", href: "/knowledge/psp/dlocal", description: "Pagamentos LATAM com dLocal" },
