...
export const BADGES: Badge[] = [
  ...
  { id: "perfection", name: "Perfeição", icon: "💯", description: "Acertou todos os quizzes com 100%", category: "student", xpReward: 200, condition: { type: "quizzes_perfect", threshold: 18 } },
  ...
  { id: "master", name: "Mestre", icon: "🏆", description: "Completou todas as trilhas", category: "trailblazer", xpReward: 300, condition: { type: "trails_completed", threshold: 5 } },
